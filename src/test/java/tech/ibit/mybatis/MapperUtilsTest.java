...
//        user.setName("dev");
//        MapperUtils.insertDefault(new TestMapper() {
//            @Override
...
//        MapperUtils.insertDefault(new TestMapper(), user);
//    }
//
//    @Test
//    public void insert2() {
...
//        MapperUtils.deleteByIds(new TestMapper<User, Integer>() {
//            @Override
//            public int rawUpdate(@Param(SqlProvider.PARAM_SQL_PARAMS) PrepareStatement sqlParams) {
//                assertPrepareStatementEquals(
...
//        MapperUtils.updateById(new TestMapper(), user);
//    }
//
//    //多主键，某个主键为null
//    @Test
...
//        MapperUtils.updateById(new TestMapper(), org);
//    }
//
//    //某个不能为column设置为空
//    @Test
...
//        MapperUtils.updateById(new TestMapper(), user, Collections.singletonList(UserProperties.password));
//    }
//
//    @Test
...
//        User user = new User();
//        user.setType(UserType.u1);
//        assertEquals(0, MapperUtils.updateByIds(new TestMapper(), user, Collections.emptyList()));
//    }
//
...
//        thrown.expect(SqlException.class);
//        thrown.expectMessage("Table(user)'s column(password) is null!");
//        MapperUtils.updateByIds(new TestMapper(), user, Collections.singletonList(UserProperties.password), Arrays.asList(1, 2));
//    }
//
//    @Test
...
//        Organization org = new Organization();
//        org.setType(1);
//        assertEquals(0, MapperUtils.updateByMultiIds(new TestMapper(), org, Collections.emptyList()));
//    }
//
//    //测试设置某个不允许为null的列为null
//    @Test
...
//        MapperUtils.updateByMultiIds(new TestMapper(), org,
...
//                        )
//                )
//                .fromDefault(UserProperties.TABLE);
